...
def predict_profit(model, scaler, le_sexe, le_status, le_drugName, le_sellDayOfWeek, le_sellDateIsweekend, le_sellDateIsHoliday, le_sellDateSeason, le_prescriptionGivenDayOfWeek, le_prescriptionGivenDateIsweekend, le_prescriptionGivenDateIsHoliday, le_prescriptionGivenDateSeason, le_prescriptionExpirationDayOfWeek, le_prescriptionExpirationDateIsweekend, le_prescriptionExpirationDateIsHoliday, le_prescriptionExpirationDateSeason, features):
...
def ml_profit():
    ...
    features = df.drop(['SellDate', 'PrescriptionGivenDate', 'PrescriptionExpirationDate', 'Profit', ], axis=1)
    target = df['Profit']
